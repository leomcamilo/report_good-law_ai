#!/usr/bin/env python3
"""
Análise de Projetos Lei do Bem com LangChain + Claude
====================================================

Este script carrega os dados dos projetos da Lei do Bem e utiliza
o LangChain com a API do Claude para análise avançada dos dados.
"""
...
class AnalisadorLeiDoBemLangChainAnthropic:
    def __init__(self):
        self.engine = None
        self.llm = None
    ...
    def configurar_llm(self):
        """Configura o modelo LLM Claude"""
        try:
            api_key = os.getenv('ANTHROPIC_API_KEY')
            if not api_key:
                logger.error("Chave da API Anthropic não encontrada. Configure ANTHROPIC_API_KEY no arquivo .env")
                return False
            ...
            logger.info("LLM Claude configurado com sucesso")
            return True
...
"""
    ...
    def executar_analise_llm(self, dados_contexto):
        ...
        try:
            ...
            logger.info("Enviando dados para análise com Claude...")
...
def main():
    ...
    try:
        ...
        analisador = AnalisadorLeiDoBemLangChainAnthropic()
